...
public class WorldTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		terrain[1][0][1] = Terrain.WOOD.getId();
	...
	public void addUnit() throws Exception {
		...
		t.terminate();
		assertTrue(f.hasAsUnit(new Unit(w, "Test2", new Vector(0,0,0))));
		assertEquals(1, f.getNbUnits());
	}
	...
	public void canHaveAsUnit() throws Exception {
		...
		assertFalse(w.canHaveAsUnit(new Unit(LobbyWorld.lobby)));
	}
	...
	public void isAdjacentSolid() throws Exception {
		...
		assertFalse(w.isAdjacentSolid(new Vector(2,2,2)));
		assertTrue(w.isLowerSolid(new Vector(1,0,2)));
		assertTrue(w.isLowerSolid(new Vector(0,1,2)));
	}
	...
	public void isLowerSolid() throws Exception {
		...
		assertFalse(w.isLowerSolid(new Vector(2,2,2)));
		assertTrue(w.isLowerSolid(new Vector(1,0,2)));
		assertTrue(w.isLowerSolid(new Vector(0,1,2)));
	}
